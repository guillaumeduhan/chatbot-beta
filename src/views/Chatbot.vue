<template lang="pug">
#Chatbot.d-flex.flex-column.align-items-end.justify-content-between
  .branding
    Button(:interaction="branding")
  .content.d-flex.flex-column.align-items-end.justify-content-end
